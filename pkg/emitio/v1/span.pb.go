...
func (Span_SpanKind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 0}
}

// Severity levels as defined in syslog https://tools.ietf.org/html/rfc3164
type Span_Severity int32

const (
	Span_SEVERITY_UNSPECIFIED Span_Severity = 0
	// Emergency: system is unusable
	Span_EMERGENCY Span_Severity = 1
	// Alert: action must be taken immediately
	Span_ALERT Span_Severity = 2
	// Critical: critical conditions
	Span_CRITICAL Span_Severity = 3
	// Error: error conditions
	Span_ERROR Span_Severity = 4
	// Warning: warning conditions
	Span_WARNING Span_Severity = 5
	// Notice: normal but significant condition
	Span_NOTICE Span_Severity = 6
	// Informational: informational messages
	Span_INFORMATIONAL Span_Severity = 7
	// Debug: debug-level messages
	Span_DEBUG Span_Severity = 8
)

var Span_Severity_name = map[int32]string{
...
var Span_Severity_value = map[string]int32{
...
func (x Span_Severity) String() string {
	return proto.EnumName(Span_Severity_name, int32(x))
}
func (Span_Severity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 1}
}
...
func (Span_TimeEvent_MessageEvent_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 1, 1, 0}
}
...
func (Span_Link_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 3, 0}
}

// A span represents a single span within a trace. Spans can be
// nested to form a trace tree. Often, a trace contains a root span
// that describes the end-to-end latency, and one or more subspans for
// its sub-spans. A trace can also contain multiple root spans,
// or none at all. Spans do not need to be contiguous - there may be
// gaps or overlaps between spans in a trace.
//
// A span with no trace_id is treated as a log.
type Span struct {
	...
	// A unique identifier for a span, assigned when the span
	...
	// and a line number where the span is called. A best practice is to use
	...
	Kind Span_SpanKind `protobuf:"varint,14,opt,name=kind,enum=Span_SpanKind" json:"kind,omitempty"`
	// The end time of the span. On the client side, this is the time kept by
	// the local machine where the span execution ends. On the server side, this
	// is the time when the server's application handler stops running.
	EndTime *timestamp.Timestamp `protobuf:"bytes,5,opt,name=end_time,json=endTime" json:"end_time,omitempty"`
	// The duration of the span.
	// Zero is a valid duration and will be used for log-type spans.
	...
	ChildSpanCount *wrappers.UInt32Value `protobuf:"bytes,13,opt,name=child_span_count,json=childSpanCount" json:"child_span_count,omitempty"`
	Severity       Span_Severity         `protobuf:"varint,15,opt,name=severity,enum=Span_Severity" json:"severity,omitempty"`
	// unstructured is string data that is not parsed into attributes
	// or message events. A secondary downstream enrichment program
	// may attempt to parse the unstructured data into attributes.
	//
	// unstructured is optional
	Unstructured         *TruncatableString `protobuf:"bytes,16,opt,name=unstructured" json:"unstructured,omitempty"`
...
func (*Span) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0}
}
...
func (m *Span) GetSeverity() Span_Severity {
	if m != nil {
		return m.Severity
	}
	return Span_SEVERITY_UNSPECIFIED
}

func (m *Span) GetUnstructured() *TruncatableString {
	if m != nil {
...
func (*Span_TimeEvent_Annotation) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 1, 0}
}
...
type Span_TimeEvent_MessageEvent struct {
	...
	// received.
	Type Span_TimeEvent_MessageEvent_Type `protobuf:"varint,1,opt,name=type,enum=Span_TimeEvent_MessageEvent_Type" json:"type,omitempty"`
...
func (*Span_TimeEvent_MessageEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 1, 1}
}
...
func (*Span_TimeEvents) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 2}
}
...
type Span_Link struct {
	...
	Type Span_Link_Type `protobuf:"varint,3,opt,name=type,enum=Span_Link_Type" json:"type,omitempty"`
...
func (*Span_Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 3}
}
...
func (*Span_Links) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{0, 4}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{1}
}
...
func (*AttributeValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{2}
}
...
func (*StackTrace) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{3}
}
...
func (*StackTrace_StackFrame) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{3, 0}
}
...
func (*StackTrace_StackFrames) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{3, 1}
}
...
func (*Module) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{4}
}
...
func (*TruncatableString) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_6f2f912fd22b0e8f, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*Span_Attributes)(nil), "Span.Attributes")
	proto.RegisterMapType((map[string]*AttributeValue)(nil), "Span.Attributes.AttributeMapEntry")
	proto.RegisterType((*Span_TimeEvent)(nil), "Span.TimeEvent")
	proto.RegisterType((*Span_TimeEvent_Annotation)(nil), "Span.TimeEvent.Annotation")
	proto.RegisterType((*Span_TimeEvent_MessageEvent)(nil), "Span.TimeEvent.MessageEvent")
	proto.RegisterType((*Span_TimeEvents)(nil), "Span.TimeEvents")
	proto.RegisterType((*Span_Link)(nil), "Span.Link")
	proto.RegisterType((*Span_Links)(nil), "Span.Links")
	proto.RegisterType((*Status)(nil), "Status")
	proto.RegisterType((*AttributeValue)(nil), "AttributeValue")
	proto.RegisterType((*StackTrace)(nil), "StackTrace")
	proto.RegisterType((*StackTrace_StackFrame)(nil), "StackTrace.StackFrame")
	proto.RegisterType((*StackTrace_StackFrames)(nil), "StackTrace.StackFrames")
	proto.RegisterType((*Module)(nil), "Module")
	proto.RegisterType((*TruncatableString)(nil), "TruncatableString")
	proto.RegisterEnum("Span_SpanKind", Span_SpanKind_name, Span_SpanKind_value)
	proto.RegisterEnum("Span_Severity", Span_Severity_name, Span_Severity_value)
	proto.RegisterEnum("Span_TimeEvent_MessageEvent_Type", Span_TimeEvent_MessageEvent_Type_name, Span_TimeEvent_MessageEvent_Type_value)
	proto.RegisterEnum("Span_Link_Type", Span_Link_Type_name, Span_Link_Type_value)
}

func init() { proto.RegisterFile("emitio/v1/span.proto", fileDescriptor_span_6f2f912fd22b0e8f) }

var fileDescriptor_span_6f2f912fd22b0e8f = []byte{
	// 1494 bytes of a gzipped FileDescriptorProto
	,
}
